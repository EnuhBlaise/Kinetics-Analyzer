...
| **Single Monod (Haldane)** | 5: +qmax, Ks, Y, b_decay, Ki| Haldane model with substrate inhibition |
| **Single Monod + Lag** | 5:qmax, Ks, Y, b_decay, t_lag| Lag phase, no oxygen dynamics |
| **Single Monod + Lag (Haldane)** | 6: qmax, Ks, Y, b_decay, Ki, t_lag | Lag phase with substrate inhibition |
| **Dual Monod** | 6: qmax, Ks, Y, b_decay, Yo2, Ko2 | Oxygen dynamics, no inhibition |
| **Dual Monod (Haldane)** | 7:qmax, Ks, Y, b_decay, Yo2, Ko2, Ki| Oxygen dynamics with substrate inhibition |
| **Dual Monod + Lag** | 7:qmax, Ks, Y, b_decay, Yo2, Ko2, t_lag| Oxygen dynamics with lag phase |
| **Dual Monod + Lag (Haldane)** | 8:qmax, Ks, Y, b_decay, Yo2, Ko2, Ki, t_lag | Full model with lag phase and inhibition |
